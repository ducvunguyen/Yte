...
<form action="{{route('admin.banner.update', $data->id)}}" method="POST" role="form"  enctype="multipart/form-data">
    <legend>Thêm gói dịch vụ </legend>
    @csrf
    <div class="form-group">
        <label for="">Tên Silde </label>
        <input type="text" class="form-control" id="" placeholder="Tiêu đề lớn"  name="name" value="<?php echo $data->name ?>">
    </div>
    <div class="form-group">
